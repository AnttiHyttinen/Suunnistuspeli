...
Pelin voi aloittaa vasta, kun GPS-sijainti on enintään 10 metrin päässä lähtöpisteestä. Oma sijainti näkyy kartalla aloitukseen saakka ja piilotetaan pelin käynnistyessä. Pelin aikana näkymä on koko ruudun kartta, jossa on vain keskeytyspainike. Pelin voi keskeyttää `Lopeta peli` -painikkeella, jolloin sovellus varmistaa keskeytyksen omalla popup-ikkunalla ja näyttää siihen saakka kuljetun reitin. Löydetyn rastin karttamerkki täyttyy vihreäksi.
